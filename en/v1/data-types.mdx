...
description: >
  Discover Rust's core data types! This guide covers scalar and compound types, type inference, and best practices—with hands-on code, shadcn components, and fun explanations.
slug: data-types
version: v1
date: 2025-04-23
---
...
<Alert variant="success">
  ...
  <AlertDescription>
    Rust is a <strong>statically typed</strong> language—every variable has a type. But thanks to <strong>type inference</strong>, you don’t always have to write them out!
  </AlertDescription>
</Alert>
...
- <code>i32</code>, <code>u64</code>, etc. — Integers (signed & unsigned)
- <code>f32</code>, <code>f64</code> — Floating-point numbers
- <code>bool</code> — true or false
- <code>char</code> — a single character like <code>'a'</code>, <code>'🦀'</code>
...
<Alert variant="secondary">
  <AlertDescription>
    📌 Arrays have a fixed size. If you need a growable list, you'll want a <code>Vec</code> (we’ll get there 😉).
  </AlertDescription>
</Alert>
...
<Alert variant="success">
  <AlertDescription>
    🦀 Rust is type-safe but <strong>not intimidating</strong>—it just wants to be clear and correct!
  </AlertDescription>
</Alert>
